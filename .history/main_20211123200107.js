...
let innerListt = document.createElement("div");
listt.appendChild(innerListt);
arrayForData.forEach((arr) => {
  toBeRenderedArrayList.push("<p class= poop>" + arr.sitenamekey + "</p>");
  toBeRenderedArrayList.push("<h4>" + arr.urlkey + "</h4>");
});
innerListt.innerHTML = toBeRenderedArrayList.join(" ");
